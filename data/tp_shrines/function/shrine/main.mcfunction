execute unless items block ~ ~ ~ container.10 barrier run function tp_shrines:shrine/click/1
execute unless items block ~ ~ ~ container.11 barrier run function tp_shrines:shrine/click/2
execute unless items block ~ ~ ~ container.12 barrier run function tp_shrines:shrine/click/3
